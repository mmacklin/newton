...
- Add a reduced elastic clamp moment example where a blade clamped between a fixed wall and a spinning drum twists through the joint rotational coupling while an uncoupled blade stays flat
