...
- Add `ModalGeneratorCraigBampton` for building named six-DOF interface modes from vendor-neutral reduced mass, stiffness, damping, and recovery arrays while omitting trailing fixed-interface modes
