...
class Example:
    ...
    def _build_scene(self, builder: newton.ModelBuilder) -> None:
        ...
        anchor, _anchor_shape = self.add_box(builder, (1.0, 1.0, 1.0), 0.0, 0.5, (0.0, 0.0, 14.0), label="anchor")
        block, _block_shape = self.add_box(builder, (2.0, 2.0, 2.0), 1.0, 0.5, (0.0, 0.0, 8.0), label="block")
        self.add_cable_joint(
            builder,
            anchor,
            block,
            (0.0, 0.0, 0.0),
