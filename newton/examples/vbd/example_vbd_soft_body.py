...
class Example:
    ...
    def _validate_scene(self) -> None:
        ...
        for stack in range(3):
            stack_indices = self.body_indices_with_prefix(f"soft_{stack}_")
            ...
            positions_by_label = {
                ...
                for label, body in self.body_labels.items()
        ...
        self.assert_final_speed_below(1.0)
        self.assert_final_angular_speed_below(2.0)
